...
const Courtrecord = () => {
  ...
  return (
    <div>
      <APPBAR />
      <div>
        <h2 className='head-head2'>Court Record API</h2>
        <p className='p-p1'>
        Use the Endato Data Suite to collect information about specific court cases and details relating to them. Search and API products help users verify and collect accurate information from available public court records.
        </p>
        <div className='LINKS-centered'>
          ...
          <span style={{ margin: '0 10px' }}>&gt;</span>
          <Link to='/courtrecord-data'>Court Record Data</Link>
        </div>
        <div className='grey'>
