...
import CardRow4 from '../small components/CardRows4';
...
const PropertyData = () => {
  ...
  return (
    <div>
      <APPBAR />
      <div>
        <h2 className='head-head2'>Property Data API</h2>
        <p className='p-p1'>
        Use the Endato Data Suite to verify information on searched properties and collect additional relevant data. Search and API tools make finding property information easier and more reliable with research backed by thousands of credible data sources.
        ...
        <div className='LINKS-centered'>
          ...
          <span style={{ margin: '0 10px' }}>&gt;</span>
          <Link to='/property-data'>Property Data</Link>
        </div>
        <div className='grey'>
